...
public class Program
{
	...
	public ClassNames pickedClass;
	
	
	public void Main()
	{
		pickedClass = new ClassNames();
		/*string classInput = Console.ReadLine();
		pickedClass.currentClass = ClassNames.Classes.classInput;
		pickedClass.CheckClass();*/
		...
		Console.WriteLine("Please insert your favorite subject:");
	...
	public Classes currentClass = Classes.Math;
	...
	public void CheckClass() 
	{
		switch (currentClass) {
			case Classes.Math:
				...
				break;
			case Classes.English:
				Console.WriteLine("English Class");
				break;
			case Classes.Science:
				Console.WriteLine("Science Class");
				break;
			case Classes.Engineering:
				Console.WriteLine("Engineering Class");
				break;
		}
	}
	}
